...
{
    /// <summary>
    /// Summary description for JanusUnitTest
    /// </summary>
    [TestClass]
    public class JanusUnitTest
    {
        public List<int> _dilutionPoints;

        public string InputText
        {
            get
            {
                return "RTS-TUBE-031\tA01\t0122688502\tNCGC00345104-01\t10mM\r\n" +
        ...
        public JanusUnitTest()
        {
            //_dilutionPoints = FOTSLibrary.JanusJob.DilutionPoints;
